...
func TestAll(manager session.IManager, t *testing.T) {
...
func TestAddAndGet(w http.ResponseWriter, req *http.Request, manager session.IManager, t *testing.T) {
...
func TestAddAndPop(w http.ResponseWriter, req *http.Request, manager session.IManager, t *testing.T) {
	if err := manager.Add(w, req, "key", "value"); err != nil {
		t.Errorf("Should add session correctly, but got %v", err)
	}
...
func TestFlash(w http.ResponseWriter, req *http.Request, manager session.IManager, t *testing.T) {
...
func TestLoad(w http.ResponseWriter, req *http.Request, manager session.IManager, t *testing.T) {
	type result struct {
		Name    string
		Age     int
		Actived bool
